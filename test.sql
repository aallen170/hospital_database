...
create database if not exists cs430_project2;
...
CREATE TABLE IF NOT EXISTS Make_Drug (
	trade_name CHAR(20),
...
CREATE TABLE IF NOT EXISTS Sell (
	...
	FOREIGN KEY (trade_name, pharm_co_name) REFERENCES Make_Drug(trade_name, pharm_co_name)
);
